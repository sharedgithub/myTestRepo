...
public class TestArrays implements Comparable<TestArrays>{
	...
	public TestArrays(int num, String name) {rollNo=num;studentName=name;}
	...
	public boolean equals(Object t) {
		if((t instanceof TestArrays) && ((TestArrays)t).getRollNo()==rollNo && ((TestArrays)t).getStudentName()==studentName) {
			return true;
		}
		return false;
	}
	
	// overriding hascode method as when equals method will be used then we have to make sure hashcode of the object is also same
	public int hasCode(TestArrays t) {
		// implement any hashcoding algorithm 
		//hashing is basically provind int ID to object by using any login
		return t.rollNo;
	}
...
//		strArray[11]="234"; 
		...
		// for comparator we have to pass it to the collection.sort or array .sort method
		...
		Collections.sort(l); // when you try to sort your object, without implementing comparable interface, you will get TestArrays cannot be cast to java.lang.Comparable exception
